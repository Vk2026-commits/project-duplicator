...
export default function Onboarding() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Agreements signed successfully! Welcome to the group.");
      navigate("/dashboard");
    } catch (err: any) {
          ...
          <CardContent className="p-8">
            ...
            {step === 1 && (
              <div className="space-y-6 text-center">
                ...
                <h1 className="font-display text-3xl font-bold">Welcome to The Fellows Investment Group LLC</h1>
                <p className="text-muted-foreground leading-relaxed max-w-lg mx-auto">
                  This is a private investment group where members pool capital, evaluate opportunities,
                  and build wealth collectively. Before accessing the platform, please review and agree
                  to the group's operating terms.
                </p>
            ...
            {step === 2 && (
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-display text-2xl font-bold">Investment Terms</h2>
                </div>
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground">
                  All investments carry risk. Please confirm you understand the following:
                </p>
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground">
                  To protect all members and the group's interests, please agree to the following:
                </p>
                <div className="space-y-3">
                  {[
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-secondary/30 rounded-lg p-6 border border-border space-y-3">
                    <h3 className="font-semibold">By joining, I commit to:</h3>
            ...
            {step === 6 && (
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  and Member Onboarding Packet of The Fellows Investment Group LLC.
                </p>
                <div className="space-y-4">
